...
Proof.
  ...
  - exact false.
  - exact true.
Defined. (* The actual construction is important, if you used Qed you'd mean that it's not and it would not be accesible because it's opaque*)
